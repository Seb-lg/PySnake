...
import math
from neat.neatnode import Node
from neat.neatconnection import Connection
...
class NeatNeuralNetwork(object):
	...
	def run(self, input_data):
		for i in range(0, len(input_data)):
			if input_data[i] == 0.0:
				input_data[i] = 0.000001
			self.input[i].total = math.log10(input_data[i]/(1-input_data[i]))
